 ...
 */
let config = {
    darksky_api: "03bd2d6a152e5a616c5cd89ac527cb71", //从https://darksky.net/dev/ 上申请key填入即可
    aqicn_api: "3682207b7185a5b56bd3dd2f4d1e4619d44b4b45", //从http://aqicn.org/data-platform/token/#/ 上申请key填入即可
    huweather_apiKey: "faead3de5f42420098c8132b3924cd09", //和风天气APIkey,可自行前往 https://dev.heweather.com/ 进行获取
    lat_lon: "27.065072,106.027402", //请填写经纬度,直接从谷歌地图中获取即可
...
[24小时天气]
$[hourly($[month]月$[day]日  $[temperatureLow]~$[temperatureHigh]°C  $[weatherIcon]$[weather])]`
        },
